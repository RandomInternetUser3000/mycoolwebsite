...
import { fetchAllowlistFromGithub } from './allowlist.js';
import { sendJson } from './http.js';

const SESSION_COOKIE = 'coolman_session';
const STATE_COOKIE = 'coolman_state';

// In production (Vercel), cookies should always be secure (HTTPS only)
// In local dev, allow insecure cookies for testing over HTTP
